...
export const TASK_REPOSITORY_LOGS = {
    ...
    FIND_TODAY_TASKS_FOR_ELO: "taskRepository.findTodayTasksForElo",
    FIND_WEEK_TASKS_FOR_ELO: "taskRepository.findWeekTasksForElo",
    FIND_ACTIVE_BY_USER_IN_RANGE: "taskRepository.findActiveByUserInRange",
    FIND_ACTIVE_NO_DATE: "taskRepository.findActiveNoDate",
